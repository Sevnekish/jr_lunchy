...
describe Api::OrdersController do
  ...
  describe "GET #index" do
    ...
    context 'when user is authorized successfully' do
      before { get :index }
      context "without params" do
        it "returns orders records for today date" do
      ...
      context 'with date param' do
        ...
        it "returns orders records for date from params" do
          orders_response = json_response[:orders]
      ...
      context 'with organization param' do
        ...
        it "returns orders records for organization from params" do
          orders_response = json_response[:orders]
